...
public class ComplaintEditViewModel
{
    ...
    // To display existing attachments (read-only in this view model context, usually)
    // But for simplicity in the Edit view, we might just show them and allow adding more.
}
